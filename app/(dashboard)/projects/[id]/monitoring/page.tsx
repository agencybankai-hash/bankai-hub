        ...
        <div className="rounded-xl border border-white/[0.06] bg-[#111827] p-4 space-y-3">
          <div className="flex gap-3">
            <input
              ...
              className="flex-1 rounded-lg border border-white/[0.06] bg-white/[0.03] px-3 py-2 text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-blue-500"
      ...
      {configs.length === 0 ? (
        ...
        <div className="space-y-3">
          {configs.map((config) => (
            <div
              key={config.id}
              className={`rounded-xl border bg-[#111827] p-4 transition-colors cursor-pointer ${
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-1 shrink-0" onClick={(e) => e.stopPropagation()}>
                  <button
                    ...
                    className="p-1.5 rounded-lg text-slate-400 hover:text-blue-400 hover:bg-white/5 transition-colors disabled:opacity-50"
